...
class Acl
{
     ...
     * @param Role|string $role The role or his name
    ...
    public function isAllowed($role, $resource, $scope = 'global')
    {
        ...
        $resource = (is_a($resource, 'Resource')) ? $resource : $this->getResource($resource, $scope);
